...
for (i=0; i < room_width; i+= tile_width)
{
    for (j=0; j < room_height; j+= tile_height)
    {
        ...
        tile_add(background_tileset, floor_rand, 0, tile_width, tile_height, i, j, 3000000);
        tile_add(background_tileset, floor_rand, 0, tile_width, tile_height, i+room_width, j, 3000000);
        tile_add(background_tileset, floor_rand, 0, tile_width, tile_height, i-room_width, j, 3000000);
    }
}
