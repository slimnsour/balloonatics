...
gp_down_pressed = gamepad_button_check_pressed(0, gp_padd) || (gamepad_axis_value(0,gp_axislv) > 0.75);
gp_up_pressed = gamepad_button_check_pressed(0, gp_padu) || (gamepad_axis_value(0,gp_axislv) < -0.75);
...
input_up_pressed = key_up_pressed || gp_up_pressed;
input_down_pressed = key_down_pressed || gp_down_pressed;
